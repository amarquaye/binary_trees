...
/**
 * check_parent - This checks if node has a lower/higher than its grand parent
 *
 * @tree: actual node
...
/**
 * check_is_bst - This checks if binary tree is a BST
 *
 * @tree: tree root
...
/**
 * binary_tree_is_bst - This calls to check_is_bst to check if tree is BST
 *
 * @tree: tree root
 * Return: 1 if tree is a BST, 0 otherwise
 */
