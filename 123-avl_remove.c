...
/**
 * check_balance_avl - This checks the balance of each node
 *
...
/**
 * inorder_sucessor - This determines the next/previous node of the removed node
 *
...
/**
 * change_node - This changes the removed node by the next/previous node
 *
...
/**
 * avl_search_remove - This searches to remove a node in an AVL tree
 *
 * @tree: tree root
 * @value: node value
...
/**
 * avl_remove - This removes a node in an AVL tree
 *
 * @root: tree root
 * @value: node value
