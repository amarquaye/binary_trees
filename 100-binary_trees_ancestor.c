...
/**
 * recursive_depth - This measures the depth of a node in a binary tree
 *
 * @tree: tree root
...
/**
 * binary_tree_depth - This calls recursive_depth to return the depth
...
/**
 * binary_tree_uncle - This finds the lowest common ancestor of two nodes
 *
